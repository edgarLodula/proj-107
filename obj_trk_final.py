...
def drawBox(img,bbox):
    ...
    cv2.putText(img, "Rastreando", (50,50), cv2.FONT_HERSHEY_SCRIPT_SIMPLEX, 0.7, (0,255,0),2)
...
while True:
   ...
   if succes:
        ...
        cv2.putText(img, "Errou", (50,50), cv2.FONT_HERSHEY_SCRIPT_SIMPLEX, 0.7, (0,0,255),2)
